...
export const getBoundaryEdgeKeys = (
  graph: PlanarGraph,
  fKey: string
): string[] => {
...
export const getBoundaryVertexKeys = (
  graph: PlanarGraph,
  fKey: string
): string[] => {
...
export const getBoundaryVertices = (
  graph: PlanarGraph,
  fKey: string
): Vertex[] => {
...
export const getOutgoingEdgeKeys = (
  graph: PlanarGraph,
  vKey: string
): string[] => {
