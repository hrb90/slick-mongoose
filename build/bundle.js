...
var default_graph_1 = __webpack_require__(9);
var util_1 = __webpack_require__(0);
...
var GraphDrawingWrapper = /** @class */ (function () {
    ...
    GraphDrawingWrapper.prototype.setDefaultGraph = function () {
        this.clearGraph();
        this.graph = default_graph_1.DEFAULT_GRAPH;
        this.highlightedGraph = this.graph;
        this.vertices = util_1.values(this.graph.vertices);
    };
